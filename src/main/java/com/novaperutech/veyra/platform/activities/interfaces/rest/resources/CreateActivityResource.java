 ...
 * @param type the activity type as a string (must match {@link com.novaperutech.veyra.platform.activities.domain.model.valueobjects.ActivityType})
 * @param title the descriptive title of the activity
 * @param isRecurring whether the activity repeats on specific days
 * @param recurringDays the days on which the activity recurs as strings (must match {@link com.novaperutech.veyra.platform.activities.domain.model.valueobjects.RecurringDay})
 */
