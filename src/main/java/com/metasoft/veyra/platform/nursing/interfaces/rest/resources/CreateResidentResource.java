...
public record CreateResidentResource(
        ...
        @NotBlank(message = "Legal representative first name is required")
        String legalRepresentativeFirstName,

        @NotBlank(message = "Legal representative last name is required")
        String legalRepresentativeLastName,

        @NotBlank(message = "Legal representative phone number is required")
        String legalRepresentativePhoneNumber,
