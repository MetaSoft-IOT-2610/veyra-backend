workspace "Veyra Platform - System Landscape" "High-level map of the Veyra ecosystem within the nursing home enterprise." {
  ...
  model {
    ...
    group "Veyra Nursing Home" {
      ...
      nurse         = person "Nurse"                      "Registers and updates resident clinical data at the facility."                   "Nurse"
    ...
    nurse         -> veyraPlatform "Records and updates resident clinical and operational data"          "HTTPS"
